...
/**
	...
	@param {AsyncGenerator<ArrayBuffer>} chunks A generator of data chunks that represents the stream to digest; chunk sizes are expected to be multiples of 512 (bytes) except the last chunk (which will be padded as necessary per MD5 specification); if sizes of chunks other than that of the last chunk are not multiples of 512, the effect of calling this procedure is not defined
...
*/
export async function digest(chunks, { instance = WASM_default_module_instance } = {}) {
